...
?>
              ...
              <tbody>
                ...
                <td bgcolor="#c0c5cc">{{$hasil_ta->updated_at}}</td>
   ...
   <!-- Modal -->
    ...
    <div class="modal-dialog">
      ...
      <div>
          <a href="/mahasiswa/ubah-dokumen-ta-final/{{$hasil_ta->id_tugas_akhir}}"   >
...
@else
    ...
    <form action="{{ url('mahasiswa/upload-hasil-ta-final') }}" enctype="multipart/form-data" method="POST">
